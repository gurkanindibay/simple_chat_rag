export function IngestedPDFsCard({ ingested }) {
  if (!ingested) {
    return (
      <div className="card">
        <h3>
          <i className="fas fa-file-pdf card-icon"></i> Ingested PDFs
        </h3>
  ...
  return (
    <div className="card">
      <h3>
        <i className="fas fa-file-pdf card-icon"></i> Ingested PDFs ({ingested.length})
      </h3>
      {ingested.length === 0 ? (
        <div className="empty-state">
